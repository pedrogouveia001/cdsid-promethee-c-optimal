...
uses ufrmAvaliacao, uAPI_LPSolve;

const
{$IFDEF UNIX}
  LPSOLVELIB = 'liblpk51.so';
{$ELSE}
  LPSOLVELIB = 'lpsolve51.dll'; //SERVIDOR
  //LPSOLVELIB = 'C:\Users\Lucas Borges\Desktop\DO PPGEP-UFPE (2019 - atual)\Projetos de Pesquisa\PRONEX) Seleção de Portfólio de Projetos com PROMETHEE\Sistema de Apoio a Decisão\PU_PXCNG_WT1_v3\Code\lpsolve51.dll';
{$ENDIF}
